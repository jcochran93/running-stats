...
def strava():
    ...
    # url = client.authorization_url(client_id=MY_STRAVA_CLIENT_ID, redirect_uri='www.jarredcochran.com/authorization', scope=['read_all','profile:read_all','activity:read_all','activity:write'])
